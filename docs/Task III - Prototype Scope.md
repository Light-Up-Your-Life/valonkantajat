...
It shows that lighting behaves the same in all demo rooms (001), operates reliably (002), can handle multiple rooms (003), and is easy to install (004) for non-technical users.  
The prototype proves that the system meets key operational requirements and supports staff efficiency and room verification.  
