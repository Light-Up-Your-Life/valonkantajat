...
| IT Manager | "Every device is a new attack surface" | VLAN isolation, no default credentials |
...
| Installation Tech | "I'm on a different network than the devices and I can't get IT on the phone." | Full offline commissioning mode, local mesh device discovery |
